...
export async function POST(){
  ...
  const result=await sendTransactionalEmail({
    to:MASTER_EMAIL,
    subject:'Prueba de correo TURNAVIA',
    html:turnaviaEmail('Correo de prueba',`<p>Si recibiste este mensaje, los correos transaccionales de TURNAVIA están funcionando correctamente.</p><p><strong>Destino de prueba:</strong> ${MASTER_EMAIL}</p>`)
  });
