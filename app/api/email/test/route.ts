...
export async function POST(){
  ...
  const result=await sendTransactionalEmail({
    ...
    html:turnaviaEmail('Correo de prueba',`<p>Si recibiste este mensaje, los correos transaccionales de TUCITA están funcionando correctamente.</p><p><strong>Destino de prueba:</strong> ${MASTER_EMAIL}</p>`)
  });
