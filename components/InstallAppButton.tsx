...
export function InstallAppButton(){
  ...
  const click=async()=>{
    ...
    else alert('Para instalar TUCITA: abre esta página con Chrome o Edge por HTTPS (o localhost), espera unos segundos y vuelve a tocar “Instalar TUCITA”. También puedes usar el menú del navegador → Instalar aplicación.');
  };
  return <button className="btn btn-secondary" onClick={click}><Download size={16}/> Instalar TUCITA</button>
}
